...
force ace_scopes_zeroReferenceTemperature = 55;
...
force ace_weather_enableServerController = true;
force ace_weather_useACEWeather = false;
force ace_weather_syncRain = true;
force ace_weather_syncWind = true;
force ace_weather_syncMisc = true;
...
force ace_advanced_ballistics_simulateForSnipers = false;
